/**
 * This is the Armadyl Godsword special attack (The Judgement)
 *
...
function prepare(attacker, target, damage){
	damage.add(MeleeAttack.roll(attacker, target, 2.0, 1.375));
}
...
function perform(attacker, target, damage){
	attacker.animate(11989);
	attacker.graphics(2113);
	wait(1);
