importClass(org.maxgamer.rs.model.entity.mob.combat.mage.MagicAttack);
...
function prepare(attacker, target, damage){
	damage.add(MagicAttack.roll(attacker, target, 1.5));
}
...
function perform(attacker, target, damage){
	attacker.animate(14788);
	attacker.graphics(1729);
	wait(2);
 ...
 */
function getMaxDistance(attacker){
	return 5;
}
