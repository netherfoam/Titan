chat(npc, "Dooooom!");
chat(player, "Where?");
chat(npc, "All around us! I can feel it in the air, hear it on the wind, smell it...also in the air!");
...
chat(player, "Thanks, I'll remember that if I see any warning\nmessages.");
