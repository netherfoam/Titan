...
public abstract class Window {
     ...
     * @param offset      the starting index of the containers items. Eg for inventory this is 0.
     * @param length      the number of items. Eg for inventory this is 27
     * @param componentId the child ID of the interface to modify. This is frequently 0.
     */
     ...
     * @param length      the number of items. Eg for inventory this is 27
     * @param componentId the child ID of the interface to modify. This is frequently 0.
     * @param options     the options to unlock in this window
     */
     ...
     *
     * @param option   the option number that was used. Eg, right click provides multiple options
     * @param buttonId the buttonId that was clicked
     * @param slotId   the slot that was clicked, possibly 65536 (-1)
     * @param itemId   the item ID that was clicked, possibly -1, not to be trusted.
     */
