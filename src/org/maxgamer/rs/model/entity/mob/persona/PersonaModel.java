...
public class PersonaModel extends MobModel implements YMLSerializable {
	...
	/**
	 * If this flag is set, then the graphics to render has no equipment to overlay
	 */
	...
	protected void appendUpdate(OutputStreamWrapper out) throws IOException {
		if (npcModelId == -1) {
			...
			out.writeShort(-1);
			out.writeShort(npcModelId);
			out.writeByte(0); // unidentified
		}
	}
