...
public abstract class Container implements Cloneable, Iterable<ItemStack>, YMLSerializable {
	...
	public final synchronized boolean transferTo(Container to, ItemStack... items) {
		//It's much faster to do it with two proto sets, than check, remove, add, fail, re-add - Even if code is shorter!
	...
	public final void shift() {
		...
		//Starting at the first empty slot, we want to move all items back down.
	...
	public final void insert(int slot, ItemStack item, boolean reverse) {
		//This is the first free spot, after or before (reverse applies) the given slot.
		int freeSpot = -1;
