 ...
 *
 * @param <M>
 *            the type of minigame this npc is associated with
 */
public class MiniGameNPC<M extends MiniGame> extends NPC {
	...
	/**
	 * This holds a various amount of configurations for this {@code MiniGameNPC}.
	 */
	 ...
	 * 
	 * @param minigame
	 *            the minigame this npc is associated with
	 * @param defId
	 *            the id of this npc
	 * @param l
	 *            the location to set the npc at
	...
	/**
	 * This method is executed every game tick * the value returned. If the return value is -1, this
	 * {@code PestControlNPC} will stop ticking. The default return value is set to -1.
	 * 
	...
	/**
	 * Transforms this {@code MiniGameNPC} into a new {@code MiniGameNPC} and returns the
	 * transformed npc.
	 * 
	 * @param npcId
